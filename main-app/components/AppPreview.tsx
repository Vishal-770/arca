...
export default function AppPreview() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative w-full pt-32 pb-40 overflow-hidden bg-background"
    >
      {/* Subtle Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] h-[50%] bg-ring rounded-full blur-[200px] opacity-[0.03] pointer-events-none" />
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 flex flex-col items-center text-center">
        ...
        <motion.div
           ...
           className="inline-flex items-center gap-2 px-4 py-2 bg-background border border-border/40 rounded-full mb-8 backdrop-blur-md"
        >
          <ShieldCheck className="h-3.5 w-3.5 text-ring" />
        ...
        >
          ...
          <Link href="/docs" className="flex h-14 w-full sm:w-auto px-8 items-center justify-center gap-2 rounded-full border border-border bg-background text-sm font-semibold text-foreground hover:bg-background/80 transition-colors">
        ...
        >
          ...
          <div className="absolute inset-0 bg-background/20 blur-[100px] rounded-[3rem] -z-10" />
          
          {/* Premium Bezel Container */}
          <div className="relative rounded-[2.5rem] border border-border/40 bg-background p-2 md:p-3 shadow-2xl overflow-hidden">
             
             {/* Inner Screen */}
             <div className="relative rounded-[1.8rem] md:rounded-[2rem] overflow-hidden border border-border/20 bg-background">
                {/* Image */}
                <Image 

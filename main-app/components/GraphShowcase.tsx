      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-2 lg:order-1 relative group">
            ...
            <div className="relative bg-[#0b0b0f] border border-[#ffffff]/5 rounded-[2.5rem] p-8 shadow-2xl overflow-hidden min-h-[480px]">
               ...
               <div className="flex items-center justify-between mb-8 border-b border-[#ffffff]/5 pb-6">
                 ...
                 <div className="px-3 py-1 bg-[var(--ring)]/10 rounded-md border border-[var(--ring)]/20">
                    <span className="text-[10px] font-mono text-[var(--ring)] font-bold">query SellerStats</span>
                 </div>
               </div>
               ...
               <div className="font-mono text-sm leading-relaxed">
                  ...
                  <div className="text-[var(--ring)]">query <span className="text-[#ffffff]">SellerStats</span>($seller: <span className="text-[#ffffff]">Bytes!</span>) {"{"}</div>
                  ...
                  <div className="pl-12 text-[var(--ring)]">totalGrossRevenue</div>
                  <div className="pl-12 text-[var(--ring)]">totalNetRevenue</div>
                  <div className="pl-12 text-[#ffffff]">updatedAt</div>
                  <div className="pl-6 text-[#ffffff]">{"}"}</div>
                  <div className="text-[var(--ring)]">{"}"}</div>
                  ...
                  <div className="mt-8 pt-6 border-t border-[#ffffff]/5">
                    ...
                    <div className="pl-12 flex gap-2">
                        ...
                        <span className="text-[var(--ring)]">"42,000 USDC"</span>
                    </div>
            ...
            <div className="absolute -top-6 -left-6 px-6 py-4 bg-[#000000] border border-[#ffffff]/10 rounded-2xl shadow-2xl flex items-center gap-3">
               <Database className="w-4 h-4 text-[var(--ring)]" />
          ...
          <div className="order-1 lg:order-2 flex flex-col gap-8">
            <div className="px-3 py-1 bg-[var(--ring)]/10 border border-[var(--ring)]/20 rounded-full w-fit">
              <span className="text-[var(--ring)] text-[10px] font-bold uppercase tracking-[0.2em] leading-none">The Graph Protocol</span>
            </div>
            ...
            <div className="mt-8">
              <Link 
                ...
                target="_blank"
                className="inline-flex h-14 px-10 items-center justify-center rounded-xl bg-[var(--ring)] text-[#ffffff] font-black text-xs uppercase tracking-widest transition-all hover:opacity-90 group/btn"
              >
                Explore Subgraph 

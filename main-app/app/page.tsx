              ...
              {[
                {
                  ...
                  tag: "Built-in",
                  desc: "Provision non-custodial smart wallets instantly using device biometrics (WebAuthn). Zero seed phrases, zero extensions.",
                  icon: Fingerprint,
                },
                {
                  id: "session-keys",
                  title: "Autopay Session Keys",
                  ...
                  <motion.button
                    ...
                    className={`group text-left flex items-start gap-5 py-4 px-2 border-l-2 transition-all duration-300 ${
                      isActive
                        ...
                        : "border-transparent hover:border-zinc-700 bg-transparent"
                    }`}
                  >
                    <div className={`h-10 w-10 rounded-xl flex items-center justify-center shrink-0 transition-colors ${
                      isActive ? "text-ring" : "text-zinc-500 group-hover:text-zinc-300"
                    }`}>
                    ...
                    <div className="flex-1 flex flex-col items-start gap-1.5">
                      ...
                      <span className="text-sm text-zinc-500 leading-relaxed font-medium">
                        {tab.desc}
                      </span>
                    </div>
                  </motion.button>

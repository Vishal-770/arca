      ...
      <div className="flex bg-background font-mulish">
        ...
        <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-card border-b border-border z-50 flex items-center justify-between px-6">
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="font-serif font-bold uppercase tracking-widest text-sm text-foreground">Arca</span>
          </Link>
        ...
        >
          ...
          <div className="flex flex-col h-full p-6">
            ...
            <nav 
              style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
              className="flex flex-col flex-1 overflow-y-auto overflow-x-hidden [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden no-scrollbar"
            >
